...
/// </summary>
public sealed class ParameterRebinderExpressionVisitor(IReadOnlyDictionary<ParameterExpression, ParameterExpression> parametersMap) : ExpressionVisitor
{
    private readonly IReadOnlyDictionary<ParameterExpression, ParameterExpression> _parametersMap = parametersMap;
